...
export const Libs = {
  ...
  Java: {
    icon: () => <Image w={10} h={10} src="https://img.icons8.com/color/48/000000/java-coffee-cup-logo--v1.png" />,
    level: 2,
  },
  React: {
...
export const CiLibs = {
  ...
  AWS: {
    icon: () => (
      <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Amazon_Web_Services_Logo.svg/512px-Amazon_Web_Services_Logo.svg.png?20170912170050" />
    ),
    level: 3,
  },
